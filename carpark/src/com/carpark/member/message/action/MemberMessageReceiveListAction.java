...
public class MemberMessageReceiveListAction implements Action {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response)
		...
		if(receiveId != null) {
			List<MessageDto> receiveList = MemberMessageServiceImpl.getMemberMessageService().receiveListArticle(receiveId, pg, key, word);
			PageNavigator navigator = CommonServiceImpl.getCommonService().getPageNavigatorReceiver(receiveId, pg, key, word);
