...
public class MemberDaoImpl implements MemberDao {
   ...
   public int register(MemberDto memberDto) {
      ...
      try {
         ...
         String sql="";
         sql += "insert into member(user_name,user_id,user_pass,email,tel,grade_id,user_avgpoint,host_flag,login_key,logtime,coin,profile_image) \n";
         ...
         pstmt.setString(idx++, memberDto.getProfile_image());
   ...
   public List<ParkingDetailDto> list(Map<String, String> map) {
      ...
      try {
         ...
         Date from = transFormat.parse(map.get("from").trim());
         Date to = transFormat.parse(map.get("to").trim());
         
         int idx=1;
         pstmt =conn.prepareStatement(sql);
         pstmt.setString(idx++,map.get("city").trim());
         pstmt.setString(idx++,transFormat.format(from));
         pstmt.setString(idx++,transFormat.format(to));
