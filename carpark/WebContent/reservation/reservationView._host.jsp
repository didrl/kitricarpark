...
<head>
    ...
    <!-- message.js -->
    <script type="text/javascript" src="<%=root %>/message/reservationView.js"></script>
</head>
<body>
...
%>
	<table class="table">
		...
		<tr>
			...
			<p>
			<input type="button" class="btn btn-default" value="닫기" onclick="javascript:reservationView();">
			</p>
			</td>
		</tr>
	</table>    
