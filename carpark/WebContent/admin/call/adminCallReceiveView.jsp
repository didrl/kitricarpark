...
<%
CallDto callDto = (CallDto) request.getAttribute("adminCallReceiveView");
%>
...
<form action="">
	<table class="table">
		...
		<tr>
			...
			<p>
			<input type="button" class="btn btn-default" value="확정" onclick="javascript:callSendViewConfirm('<%=callDto.getSeq()%>');">
