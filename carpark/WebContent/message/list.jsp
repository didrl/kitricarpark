...
<form name="common" method="get" action="">
	<input type="hidden" name="act" id="act" value=""> <input
		type="hidden" name="bcode" id="bcode" value="1"> <input
		type="hidden" name="pg" id="pg" value="1"> <input
	...
	<div class="container-fluid">
		...
		<div class="form-group">
			<form name="searchForm" method="get" action="">
				...
				<input type="hidden" name="bcode" id="bcode" value="1"> <input
					type="hidden" name="pg" id="pg" value="1"> <select
					name="key">
					<option value="subject">제목</option>
					<option value="content">내용</option>
					<option value="user_id">작성자</option>
				</select> <input type="text" name="word" id="word" value=""> <input
					type="button" value="검색" onclick="javascript:messageSearch();">
			</form>
		</div>
		...
		<div class="table-responsive">
			<table class="table table-hover">
				...
				<tr>
					<td width="100"><a
						href="javascript:messageView('<%=messageDto.getSeq()%>');"><%=messageDto.getReceiverId()%></a></td>
					<td><a
						href="javascript:messageView('<%=messageDto.getSeq()%>');"><%=messageDto.getSubject()%></a></td>
		...
		<div class="text-center">
			<button type="button" class="btn btn-default" data-toggle="modal"
				data-target="#msgToHost">쪽지보내기</button>
		</div>
