...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "BOARD_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 862 CACHE 20 NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence CALL_NUM_PCSEQ
--------------------------------------------------------

   CREATE SEQUENCE  "CALL_NUM_PCSEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 381 CACHE 20 NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence COIN_NUM_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "COIN_NUM_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 201 CACHE 20 NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence MESSAGE_NUM_MSEQ
--------------------------------------------------------

   CREATE SEQUENCE  "MESSAGE_NUM_MSEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 361 CACHE 20 NOORDER  NOCYCLE
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "REVIEW_NUM_RSEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 261 CACHE 20 NOORDER  NOCYCLE
--------------------------------------------------------
...
Insert into PARKING (PARK_ID,PARK_NAME,PARK_CAPACITY,OWNER_ID,LATITUDE,LONGITUDE,PARK_TYPE,EMD_CODE,CONTENT,DETAIL_ADDR,PARK_PUBLIC) values (321,'구로시 코오롱싸이언스밸리 주차장',20,'IUGuest',0,0,null,null,'잘 관리하겠습니다!','서울특별시 구로구 구로동 187-10  코오롱싸이언스밸리1차',1);
...
Insert into PARKING_DETAIL (PARK_ID,PARK_FLAG,PARK_AVGPOINT,GET_STATUS,CUR_PARKING,PAY_YN,SATUR_PAY_YN,HOLI_PAY_YN,FULLTIME_MONTHLY_PAY,PARK_RATE,PARK_TIME_RATE,ADD_PARK_RATE,DAY_MAX_PAY,PARK_VISIT,FACILITY) values (1366394,1,3.875,0,0,'Y','N','N',50000,50,5,300,0,1,null);
...
Insert into MESSAGE (MSEQ,SEQ,RECEIVER_ID,MSG_FLAG,DELETE_SEND,DELETE_RECEI) values (302,786,'IUGuest',1,0,0);
...
Insert into MESSAGE (MSEQ,SEQ,RECEIVER_ID,MSG_FLAG,DELETE_SEND,DELETE_RECEI) values (202,632,'RgPark',1,0,1);
...
Insert into MESSAGE (MSEQ,SEQ,RECEIVER_ID,MSG_FLAG,DELETE_SEND,DELETE_RECEI) values (101,221,'RgPark',1,0,1);
...
Insert into MEMBER (USER_ID,USER_PASS,GRADE_ID,LOGIN_KEY,HOST_FLAG,COIN,USER_AVGPOINT,PENALTY,USER_FLAG,USER_NAME,EMAIL,TEL,PROFILE_IMAGE,LOGTIME) values ('IUGuest','iuguest',5,null,0,1790,5,0,0,'손님아이유','guestiu@guest.iu',1011444411,null,to_timestamp('16/05/26 08:30:56.000000000','RR/MM/DD HH24:MI:SS.FF'));
...
Insert into BOARD (SEQ,BCODE,USER_ID,SUBJECT,CONTENTS,LOGTIME) values (632,2,'IUGuest','오늘 강남역 궈?','강남 좋은 주차장 있음',to_timestamp('16/06/10 07:21:01.000000000','RR/MM/DD HH24:MI:SS.FF'));
...
Insert into BOARD (SEQ,BCODE,USER_ID,SUBJECT,CONTENTS,LOGTIME) values (221,2,'IUGuest','123123','123123123',to_timestamp('16/06/02 00:00:09.000000000','RR/MM/DD HH24:MI:SS.FF'));
